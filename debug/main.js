...
__p+='<li><i class="fa-li fa fa-asterisk"></i> <a title="See user favorites" href="#'+
((__t=(uid))==null?'':__t)+
'/favorites">User Favs</a><br></li></ul></div>';
}
return __p;
};
