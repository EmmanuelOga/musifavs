...
((__t=( post.title ))==null?'':_.escape(__t))+
' posted by&nbsp; <a href="#'+
((__t=( post.uid ))==null?'':_.escape(__t))+
'/posts">'+
((__t=( post.userName ))==null?'':_.escape(__t))+
'&nbsp;<i class="fa fa-child"></i></a> &nbsp; <span class="timeago">('+
((__t=( post.timeago() ))==null?'':_.escape(__t))+
')</span></li>';
 }) 
__p+='';
}
...
with(obj||{}){
__p+='<h2>'+
((__t=( stored ? 'Editing Post' : 'New Post' ))==null?'':_.escape(__t))+
...
((__t=( embed.videoId ))==null?'':_.escape(__t))+
...
((__t=(user.description))==null?'':_.escape(__t))+
'</li><li><i class="fa-li fa fa-map-marker"></i>'+
((__t=(user.location))==null?'':_.escape(__t))+
'</li>';
...
((__t=( (action == 'posts') ? ' posted anything ' : ' favorited any post ' ))==null?'':_.escape(__t))+
